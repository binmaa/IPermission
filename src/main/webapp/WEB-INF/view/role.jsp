...
<script type="text/javascript">
    $(function () {
        ...
        var hasMusltSelect=false;//有多选
        var roleListTemplate = $("#roleListTemplate").html();//获取模板
        ...
        function bindRoleClick() {
            ...
            $(".role-delete").click(function (e) {
                ...
                if(confirm("确定删除权角色【"+aclModuleName+"】吗？")){
                    $.ajax({
        ...
        $("#roleTab a[data-toggle='tab']").on("show.bs.tab",function (e) {
            if(lastRoleId == -1){
                showMessage("加载权限角色关系","请先在左侧选择操作的角色",false);
                return;
            }
            ...
            $.ajax({
                ...
                success:function (result) {
                    if(result.ret){
                        ...
                        showMessage("角色用户关系",result.msg,false);
                    }
                }
            })
        }
